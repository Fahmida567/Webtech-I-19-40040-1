    ...
    <!-- <nav class="navbar navbar-expand-sm navbar-light bg-light"> -->
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            <!-- <ul class="navbar-nav"> -->
                ...
                <li class="nav-item">
                    <a href="showAllAdvertisementsView.php" class="nav-link">Back</a> 
...
<body>
 <br><br> <br>   
 <form style="border:1px; border-style:solid; border-color: gray; padding: 1em;  text-align: center; font-size: 20px; background-color:green; " action="../Controller/deleteAdvertisementController.php" method="POST" enctype="multipart/form-data">
