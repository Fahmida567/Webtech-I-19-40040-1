...
require_once '../Controller/receiveController.php';
...
<body>
 <br><br> <br>   
 <form style="border:1px; border-style:solid; border-color: gray; padding: 1em;  text-align: center; font-size: 20px; background-color:green; " action="../Controller/rController.php" method="POST" enctype="multipart/form-data">
  ...
  <label for="details">Payment Amount:</label><br>
