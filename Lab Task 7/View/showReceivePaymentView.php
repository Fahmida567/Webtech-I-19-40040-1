	...
	<tbody>
		<?php foreach ($products as $i => $products): ?>
			<tr>
				...
				<td><a href="paymentReceiveView.php?id=<?php echo $products['ID'] ?>"><button onclick ="alert('Payment Received....')">Receive </button></a></td>
                   <td> <a href="paymentView.php?id=<?php echo $products['ID'] ?>">Delete</a></td>
			</tr>
		<?php endforeach; ?>
