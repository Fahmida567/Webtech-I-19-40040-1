	...
	<tbody>
		<?php foreach ($products as $i => $products): ?>
			<tr>
				...
				<td><?php echo $products['PHONE NO'] ?></td>
				<td><a href="paymentSendView.php?id=<?php echo $products['ID'] ?>"><button onclick ="alert('Successfully payment sent....')">Send</button></a></td>
                   <td> <a href="sPaymentView.php?id=<?php echo $products['ID'] ?>">Delete</a></td>
			</tr>
		<?php endforeach; ?>
